<x-app-layout>
    <a class="scroll-to-top rounded scroll-to-top" id="btn-back-to-top" style="display: inline;z-index:999">
        <i class="fas fa-angle-up"></i>
    </a>
    <nav class="navbar navbar-expand navbar-light bg-white order-gray-100" style="background-color: #fff!important">
        ...
        <!-- Topbar Navbar -->
        <ul class="navbar-nav ml-auto" style="padding-right: 6rem">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('dashboard')}}">
                ...
                <div class="sidebar-brand-text mx-3">TLUS <sup></sup></div>
            </a>
            ...
            <!-- Khuyến mãi -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route("admin.cv.index")}}" data-bs-toggle="collapse" data-bs-target="#collapsePromotion"
                    aria-expanded="true" aria-controls="collapsePromotion">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Hồ Sơ Nhập Học</span>
                </a>
                <div id="collapsePromotion" class="collapse {{ request()->is('admin/cv*') ? 'show' : '' }}" aria-labelledby="headingProduct"
                    data-bs-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tùy chọn:</h6>
                        <a class="collapse-item" href="{{route("admin.cv.index")}}">Danh sách hồ sơ</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUsers" class="collapse  {{ request()->is('admin/user*') ? 'show' : '' }}" aria-labelledby="headingPages" data-bs-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Users Screens:</h6>
                        <a class="collapse-item" href="{{url('/admin/user/list')}}">Danh sách</a>
                        <a class="collapse-item" href="{{url('/admin/user/add')}}">Thêm mới</a>
